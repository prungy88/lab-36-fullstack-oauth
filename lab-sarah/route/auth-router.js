...
const debug = require('debug')('sarahgram:auth-router');
...
authRouter.get('/api/auth/oauth_callback', googleOAUTH, function(req, res){
  ...
  //req.googleOAUTH is now the user's information
  ...
  .catch(err => {
    if (err.message === 'user not found'){
      //req.googleOAUTH information comes from google-oauth-middleware, is the personal information about the user
      let userData = {
