...
const userSchema = Schema({
  ...
  //don't need unique to be required true, because google users won't have a password, are just signing in with google
  password: {type: String},
  findHash: {type: String, unique: true},
  //if they're a google user, will have access to the google information below
  google: {
